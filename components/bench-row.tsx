...
export function BenchRow({ bench, teamShortNames, selectedPlayerId, onSelect }: BenchRowProps) {
  return (
    <section className="premium-panel rounded-card border border-border/70 p-3.5 md:p-4">
      ...
      <div className="grid gap-2 sm:grid-cols-4">
        {bench.map((player, index) => (
          <button
            ...
            className={`rounded-xl px-2.5 py-2.5 text-left transition focus-visible:outline-none ${
          ...
          >
            <div className="flex items-center justify-between gap-2">
              ...
              <p className="text-sm font-semibold text-brand">{player.projectedPoints.toFixed(1)} pts</p>
            </div>
