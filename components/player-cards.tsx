...
export function PlayerCards({ players, captainId, viceId, selectedPlayerId, teamShortNames, onSelect }: PlayerCardsProps) {
  ...
  return (
    <section className="premium-panel rounded-card border border-border/80 p-3.5 md:p-5">
              ...
              {group.players.map((player, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full rounded-xl px-3 py-2.5 text-left transition focus-visible:outline-none ${
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5">
                          ...
                          <p className="truncate text-[13px] font-semibold tracking-tight text-white">{player.webName}</p>
                    ...
                    <div className="mt-1.5 grid grid-cols-3 gap-1 text-[10px] text-muted sm:grid-cols-5">
                    ...
                    <p className="mt-1.5 line-clamp-2 min-h-8 text-xs leading-relaxed text-muted">{player.explanation.summary}</p>
                  </button>
                );
              })}
            </div>
